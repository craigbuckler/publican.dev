...
export function pagination( pagination ) {
  ...
  // back
  ret += `<li class="back">${ pagination.hrefBack ? `<a href="${ pagination.hrefBack }">` : '<span>' }back${ pagination.hrefBack ? '</a>' : '</span>' }</li>\n`;
  ...
  // next
  ret += `<li class="next">${ pagination.hrefNext ? `<a href="${ pagination.hrefNext }">` : '<span>' }next${ pagination.hrefNext ? '</a>' : '</span>' }</li>\n`;
