...
[Publican v0.7.0](https://www.npmjs.com/package/publican) was released on <time datetime="${{ tacs.lib.format.dateISO( '2025-04-10' ) }}">${{ tacs.lib.format.dateHuman( '2025-03-19' ) }}</time>.
