...
[Publican v0.11.0](https://www.npmjs.com/package/publican) was released on <time datetime="${{ tacs.lib.format.dateISO( '2025-10-22' ) }}">${{ tacs.lib.format.dateHuman( '2025-10-22' ) }}</time>.
