...
[Publican v0.9.0](https://www.npmjs.com/package/publican) was released on <time datetime="${{ tacs.lib.format.dateISO( data.date ) }}">${{ tacs.lib.format.dateHuman( data.date ) }}</time>.
