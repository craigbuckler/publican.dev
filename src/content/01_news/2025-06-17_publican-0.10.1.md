...
[Publican v0.10.1](https://www.npmjs.com/package/publican) was released on <time datetime="${{ tacs.lib.format.dateISO( '2025-06-17' ) }}">${{ tacs.lib.format.dateHuman( '2025-06-17' ) }}</time>.
