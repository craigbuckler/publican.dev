...
[Publican v0.10.2](https://www.npmjs.com/package/publican) and [StaticSearch v0.4.0](https://www.npmjs.com/package/staticsearch) were released on <time datetime="${{ tacs.lib.format.dateISO( '2025-06-25' ) }}">${{ tacs.lib.format.dateHuman( '2025-06-25' ) }}</time>.
