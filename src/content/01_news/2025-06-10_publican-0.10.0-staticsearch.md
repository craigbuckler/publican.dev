...
[Publican v0.10.0](https://www.npmjs.com/package/publican) was released on <time datetime="${{ tacs.lib.format.dateISO( '2025-06-08' ) }}">${{ tacs.lib.format.dateHuman( '2025-06-08' ) }}</time>.
