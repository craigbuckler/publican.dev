...
[Publican v0.6.0](https://www.npmjs.com/package/publican) was released on <time datetime="${{ tacs.lib.format.dateISO( '2025-02-26' ) }}">${{ tacs.lib.format.dateHuman( '2025-02-26' ) }}</time>.
