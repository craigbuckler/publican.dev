...
<nav class="featurelist">
  ...
  <article>
    <a href="__/tools/publican.lib/">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.1-3.1q.7-.4 1 .2a6 6 0 0 1-8.3 7l-7.9 8a1 1 0 0 1-3-3l8-8a6 6 0 0 1 7-8.2c.4.1.5.7.2 1z"/></svg><h2 class="nolink nomenu">Publican.lib</h2>
      <p>A set of template and utility functions that help you generate static web sites with Publican.</p>
    </a>
  </article>
